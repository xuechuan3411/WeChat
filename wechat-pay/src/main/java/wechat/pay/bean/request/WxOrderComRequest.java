package wechat.pay.bean.request;
...
@XStreamAlias("xml")
public class WxOrderComRequest extends WxPayBaseRequest{
	private static final String[] TRADE_TYPES = new String[]{"JSAPI", "NATIVE", "APP", "MWEB"};
	  ...
	  public WxOrderComRequest() {
	  }

	  private WxOrderComRequest(Builder builder) {
	  ...
	  public static final class Builder {
	    ...
	    public WxOrderComRequest build() {
	      return new WxOrderComRequest(this);
	    }
	  }
}
